...
def suggest_question_pattern(label,parameter=""):
    ...
    parameter = embedding[embedding['uri'] == parameter]['name'].values[0]
    if label == 'Collection':
        pattern ={
...
def reply_pattern(answer,type='answer',parameter = "",question_types=''):
    if type=='answer':
        ...
        if 'image' in question_type:
            ...
            for key, value in answer[0].items():
                res_date = 'It was created in ' + str(value)[0:4]
                response = {
                "fulfillmentMessages": [
                    {
                        "text": {
            ...
            template_response = {'fulfillmentMessages': [
                        {'payload':
                            {
                                "richContent": [
                                    [
            ...
            for dic in answer:
                ...
                if img == '' or not img:
                    ...
                    template_response['fulfillmentMessages'][0]['payload']['richContent'][0].append(
                        response_part)
                    ...
                    template_response['fulfillmentMessages'][0]['payload']['richContent'][0].append(response_part)

            template_response['fulfillmentMessages'][0]['payload']['richContent'][0].append(suggest)
        ...
        for key, value in answer[0].items():
            ...
            if 'name' in key or 'uri' in key:
                ...
                return response
    elif type == 'suggest_question' or type == "question.another":
